...
class SpiderWeibo:
    ...
    def spide_base_message(self, url):
        ...
        try:
            ...
            name = selector.xpath('/html/body/div[4]/table/tbody/tr/td[2]/div/span[1]/text()')[0].encode('utf-8')

            num_weibo = selector.xpath('/html/body/div[4]/div/span/text()')[0].encode('utf-8')
            num_watch = selector.xpath('/html/body/div[4]/div/a[1]/text()')[0].encode('utf-8')
            num_fans = selector.xpath('/html/body/div[4]/div/a[2]/text()')[0].encode('utf-8')
        ...
        try:
            for i in xrange(1, pages):
                ...
                for result in results:
                    ...
                    aweibo = Weibo(panname, send_time, content.text, res_num[0].decode('utf-8'), res_num[1].decode('utf-8'), res_num[2].decode('utf-8'))
                ...
                for htl in all_htl:
                    ...
                    if all_a[0].text:
                        ...
                        if fan_name not in nli:
                            ...
                            self.spide_base_message(str(all_a[0]['href']).decode('utf-8'))
                            self.spide_weibo_messge(str(all_a[0]['href']).decode('utf-8'), fan_name)
                print "i:" + str(i + 1)
                time.sleep(3)
